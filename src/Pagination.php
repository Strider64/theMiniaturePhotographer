...
class Pagination extends Journal {
    ...
    public function readPage() {
        ...
        $this->query = 'SELECT id, user_id, author, page, image, post, page, Model, ExposureTime, Aperture, ISO, FocalLength, heading, content, DATE_FORMAT(date_added, "%M %e, %Y") as date_added, date_added as myDate FROM cms ORDER BY myDate DESC LIMIT :perPage OFFSET :blogOffset';
